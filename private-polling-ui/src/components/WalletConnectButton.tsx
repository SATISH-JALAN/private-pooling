...
export const WalletConnectButton: React.FC<WalletConnectButtonProps> = ({
    ...
    switch (status) {
            ...
            return (
                <Tooltip title="Install Midnight Lace or 1AM wallet extension to use this dApp">
                    <Button
                        ...
                        sx={{
                            ...btnStyle, borderColor: 'rgba(244,67,54,0.5)', color: '#f44336',
        ...
        case 'found':
            return (
                <Button
                    ...
                    startIcon={<AccountBalanceWalletIcon sx={{ fontSize: 15 }} />}
                    sx={{
                        ...btnStyle, borderColor: 'rgba(168,168,168,0.4)', color: '#e0e0e0',
        ...
        case 'connecting':
            return (
                <Button disabled size="small" startIcon={<CircularProgress size={12} sx={{ color: '#a8a8a8' }} />} sx={btnStyle}>
                    Connecting…
                </Button>
            );
